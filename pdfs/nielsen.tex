...
\hypersetup{
  pdftitle={Music and Identity in Danza Azteca},
  pdfauthor={Kristina F. Nielsen},
  hidelinks,
}
...
\includegraphics{nielsen-fig1.jpg} \emph{Figure 1. Mexica New Year
Ceremony in San Jose, California in March 2016.}
...
\includegraphics{nielsen-fig2.jpg} \emph{Figure 2. The excavated ruins
of a pyramid in the central square with a colonial-era building behind
it}
...
\subsection{Music at the Mexica New Year
Ceremony}\label{music-at-the-mexica-new-year-ceremony}}

\emph{Video Example 1. Example of a dance from the 2016 Mexica New Year
...
\includegraphics{nielsen-fig3.jpg} \emph{Figure 3. Images from the
Florentine Codex that was written in the 1500s by Nahua scribes}
...
\emph{Video Example 2. Cuezalin leading ``Zan Yehuan'' at the Mexica New
Year Ceremony in San Jose, California}

\hypertarget{danza-and-articulation-theory}{%
\subsection{Danza and Articulation
...
\emph{Video Example 3. Cuezalin performing ``Zan Yehuan'' and discussing
...
Garroutte, Eva Marie. 2003. \emph{Real Indians: Identity and
the Survival of Native America}. Berkeley: University of California
Press.

Nájera-Ramírez, Olga, Norma Elia Cantú and Brenda M. Romero,
eds.~2009. \emph{Dancing Across Borders: Danzas y Bailes Mexicanos}.
Urbana: University of Illinois Press.

Scolieri, Paul A. 2013. \emph{Dancing in the New World:
