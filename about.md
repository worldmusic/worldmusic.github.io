...
If you have any questions about this project, using the resources, the submission or review process, or would like to be involved, please review the [call for contributions]({{ site.baseurl }}/call/) or contact the editors at [{{ site.email}}](mailto:{{ site.email }}).
